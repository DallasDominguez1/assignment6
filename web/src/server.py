...
def get_pf(req):
  ...
  return render_to_response('templates/productFeatures.html', {'users': records}, request=req)
...
def get_pi(req):
  ...
  return render_to_response('templates/productInteractions.html', {'users': records}, request=req)
...
if __name__ == '__main__':
  ...
  config.add_route('get_pf', '/productFeatures')
  config.add_view(get_pf, route_name='get_pf')

  config.add_route('get_pi', '/productInteractions')
  config.add_view(get_pi, route_name='get_pi')
